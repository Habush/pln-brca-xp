...
score_cols = ["test_balanced_accuracy", "test_recall_0", "test_precision_0", "test_recall_1",
               "test_precision_1", "test_auc"]
cv_df_cols = ["balanced_accuracy", "recall_0", "precision_0", "recall_1", "precision_1", "auc"]
...
def calc_scores(clf, X_test, y_test):
    ...
    arr = np.array([[acc, recall_0, precision_0, recall_1, precision_1, auc_score]])
...
def evaluate_ge(x_train, y_train, x_test, y_test, outcome_cols=None, feats=None, jobs=-1,
                params=None, scoring=scoring, rand_scoring="roc_auc", scale_weight=0):
    ...
    if scale_weight != None:
        clf_params["scale_pos_weight"] = scale_weight
